...
|------|-------|------|-------------|
| [001](001.md) | COBOL program skeleton with JSON parsing and main loop | [ ] | Create the main COBOL source file with all four divisions, working storage for buffers and state, the stdin read loop, hand-rolled JSON field extraction for incoming messages (method, id, params), and JSON response generation via STRING templates. This is the foundation everything else builds on. |
